...
## Backing field of the lazy inventory module.
...
## Returns the inventory module, creating and activating it on first access.
var inventory: InventoryModule:
	get:
		if _inventory == null:
			_inventory = InventoryModule.new(entity)
